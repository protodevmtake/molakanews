...
namespace Lunarstorm\LaravelDDD\Facades {
    ...
    class DDD {
         ...
         * @static
         */
        public static function filterAutoloadPathsUsing($filter)
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->filterAutoloadPathsUsing($filter);
        }

        /**
         * @static
         */
        public static function getAutoloadFilter()
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->getAutoloadFilter();
        }

        /**
         * @static
         */
        public static function filterApplicationLayerUsing($filter)
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->filterApplicationLayerUsing($filter);
        }

        /**
         * @static
         */
        public static function getApplicationLayerFilter()
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->getApplicationLayerFilter();
        }

        /**
         * @static
         */
        public static function resolveObjectSchemaUsing($resolver)
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->resolveObjectSchemaUsing($resolver);
        }

        /**
         * @static
         */
        public static function getObjectSchemaResolver()
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->getObjectSchemaResolver();
        }
        ...
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
            return $instance->packagePath($path);
        }

        /**
         * @static
         */
        public static function laravelVersion($value)
        {
            /** @var \Lunarstorm\LaravelDDD\DomainManager $instance */
