...
This command activates the Game Architect agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/game-architect.md](bmad/bmm/agents/game-architect.md)
