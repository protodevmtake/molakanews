...
This command activates the BMad Builder agent from the BMAD BMB module.

## File Reference

Complete agent definition: [bmad/bmb/agents/bmad-builder.md](bmad/bmb/agents/bmad-builder.md)
