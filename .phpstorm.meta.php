    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'ddd' => \Lunarstorm\LaravelDDD\DomainManager::class,
            'ddd.autoloader' => \Lunarstorm\LaravelDDD\Support\AutoloadManager::class,
            'ddd.composer' => \Lunarstorm\LaravelDDD\ComposerManager::class,
            'ddd.config' => \Lunarstorm\LaravelDDD\ConfigManager::class,
            'ddd.stubs' => \Lunarstorm\LaravelDDD\StubManager::class,
    ...
    override(\config(), map([
            ...
            'ddd.domain_path' => 'string',
            'ddd.domain_namespace' => 'string',
            'ddd.application_path' => 'string',
            'ddd.application_namespace' => 'string',
            'ddd.application_objects' => 'array',
            'ddd.layers' => 'array',
            'ddd.namespaces.model' => 'string',
            'ddd.namespaces.data_transfer_object' => 'string',
            'ddd.namespaces.view_model' => 'string',
            'ddd.namespaces.value_object' => 'string',
            'ddd.namespaces.action' => 'string',
            'ddd.namespaces.cast' => 'string',
            'ddd.namespaces.class' => 'string',
            'ddd.namespaces.channel' => 'string',
            'ddd.namespaces.command' => 'string',
            'ddd.namespaces.controller' => 'string',
            'ddd.namespaces.enum' => 'string',
            'ddd.namespaces.event' => 'string',
            'ddd.namespaces.exception' => 'string',
            'ddd.namespaces.factory' => 'string',
            'ddd.namespaces.interface' => 'string',
            'ddd.namespaces.job' => 'string',
            'ddd.namespaces.listener' => 'string',
            'ddd.namespaces.mail' => 'string',
            'ddd.namespaces.middleware' => 'string',
            'ddd.namespaces.migration' => 'string',
            'ddd.namespaces.notification' => 'string',
            'ddd.namespaces.observer' => 'string',
            'ddd.namespaces.policy' => 'string',
            'ddd.namespaces.provider' => 'string',
            'ddd.namespaces.resource' => 'string',
            'ddd.namespaces.request' => 'string',
            'ddd.namespaces.rule' => 'string',
            'ddd.namespaces.scope' => 'string',
            'ddd.namespaces.seeder' => 'string',
            'ddd.namespaces.trait' => 'string',
            'ddd.base_model' => 'NULL',
            'ddd.base_dto' => 'string',
            'ddd.base_view_model' => 'string',
            'ddd.base_action' => 'NULL',
            'ddd.autoload.providers' => 'boolean',
            'ddd.autoload.commands' => 'boolean',
            'ddd.autoload.policies' => 'boolean',
            'ddd.autoload.factories' => 'boolean',
            'ddd.autoload.migrations' => 'boolean',
            'ddd.autoload_ignore' => 'array',
            'ddd.cache_directory' => 'string',
            ...
            'filesystems.links./home/mtake/tempest/molakanews/public/storage' => 'string',
...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','ddd.domain_path',
'ddd.domain_namespace','ddd.application_path','ddd.application_namespace','ddd.application_objects','ddd.layers',
'ddd.namespaces.model','ddd.namespaces.data_transfer_object','ddd.namespaces.view_model','ddd.namespaces.value_object','ddd.namespaces.action',
'ddd.namespaces.cast','ddd.namespaces.class','ddd.namespaces.channel','ddd.namespaces.command','ddd.namespaces.controller',
'ddd.namespaces.enum','ddd.namespaces.event','ddd.namespaces.exception','ddd.namespaces.factory','ddd.namespaces.interface',
'ddd.namespaces.job','ddd.namespaces.listener','ddd.namespaces.mail','ddd.namespaces.middleware','ddd.namespaces.migration',
'ddd.namespaces.notification','ddd.namespaces.observer','ddd.namespaces.policy','ddd.namespaces.provider','ddd.namespaces.resource',
'ddd.namespaces.request','ddd.namespaces.rule','ddd.namespaces.scope','ddd.namespaces.seeder','ddd.namespaces.trait',
'ddd.base_model','ddd.base_dto','ddd.base_view_model','ddd.base_action','ddd.autoload.providers',
'ddd.autoload.commands','ddd.autoload.policies','ddd.autoload.factories','ddd.autoload.migrations','ddd.autoload_ignore',
'ddd.cache_directory','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mtake/tempest/molakanews/public/storage','fortify.guard',
...
'session.partitioned','typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers','typescript-transformer.default_type_replacements.DateTime',
...
'typescript-transformer.writer','typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','boost.enabled',
'boost.browser_logs_watcher','mcp.redirect_domains','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver',
...
'CACHE_DRIVER','CACHE_PREFIX','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
